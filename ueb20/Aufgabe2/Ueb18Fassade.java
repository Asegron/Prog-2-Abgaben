...
public class Ueb18Fassade {
	...
	public Artikel[] aufgabe_d_i(Lager lager) 
       ...
       //List<Artikel> getSorted(Comparator<Artikel> c)
           Comparator<Artikel> comp = (a,b) -> sortierkriterium.test(a, b) ? 1 : -1;
           List<Artikel> sorted = lager.getSorted(comp);
           Artikel[] sLager = new Artikel[10];
           sLager = sorted.toArray(sLager);
	   return sLager;
	}
	...
	public Artikel[] aufgabe_h_v(Lager lager) 
        {
           Artikel[] result = new Artikel[10];
           return  lager.getArticles(
                           a      -> a instanceof Buch,
